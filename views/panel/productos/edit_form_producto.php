    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <textarea class="form-control" type="text" name="descripcion" rows="10" cols="30" placeholder="Descripción producto" required="ON"><?php echo $descripcion;?></textarea>
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect01">Categoria:</label>
                </div>
                <select class="custom-select" name="categoria" id="idcategoria">
