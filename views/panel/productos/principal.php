<?php 
    ...
    if(isset($_GET['like']))
    {
        ...
        $dataProduct = CRUD($queryLike,"s");
    }
    else{
        $dataProduct = CRUD("SELECT * FROM productos ORDER BY idproducto LIMIT $inicio,$registros", "s");
...
?>
    ...
    <div style="margin-bottom: 10px;">
        <div class="row">
            <div class="col-md-2">
                <a href="" class="btn btn-success new-product"><i class="fas fa-user-plus"></i></a>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-6">
                <input type="search" class="form-control" placeholder="Busca Producto" id="like-product" autocomplete="off">
            </div>
        </div>
    </div>
    <?php if($dataProduct):?>
