...
<table class="table table-borderless table-hover table-responsive">
    <thead class="bg-dark text-white cHead">
        <tr>
            ...
            <th class="ch">Precio </br> venta</th>
            <th class="ch">Precio </br> compra</th>
            <th class="ch">Fecha </br> ingreso</th>
    ...
    <tbody>
        <?php foreach ($dataProduct as $result) : ?>
            <tr>
                ...
                <td class="ch">
                    <img src="./public/img/productos/<?php echo $result['imagen']; ?>" width="90px" alt="">
                </td>
                <td class="ch">
