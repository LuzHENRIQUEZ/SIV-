...
{
    $tabla = "productos";
    $campos = "codproducto='$codproducto', producto='$producto', descripcion='$descripcion', precio_venta='$precio_venta', precio_compra='$precio_compra', idproveedor='$idproveedor', fecha_ingreso='$fecha_ingreso', stock='$stock'";
...
else
{
    ...
    $tabla = "productos";
    $campos = "codproducto='$codproducto', producto='$producto', descripcion='$descripcion', precio_venta='$precio_venta', precio_compra='$precio_compra', idproveedor='$idproveedor', fecha_ingreso='$fecha_ingreso', stock='$stock', imagen='$newName'";
    $condicion = "idproducto='$idproducto'";
